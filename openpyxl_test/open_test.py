...
workbook = openpyxl.load_workbook("bg_test/data/behavior2023-01-01.xlsx")
...
if time_column_index is None:
    ...
    sheet.cell(1, sheet.max_column, "时间")  # Corrected the column index for "时间"
...
workbook.save("bg_test/openxl_save_file/xl_test.xlsx")