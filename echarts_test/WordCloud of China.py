...
all_data = pd.concat(pd.read_excel("bg_test/data/AllData.xlsx", sheet_name=None), ignore_index=True)
...
wordcloud.render("bg_test/html of China/WordCloud of China.html")